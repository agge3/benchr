...
def execute_job(job_data: dict) -> dict:
    ...
    print(
        f"[Agent] Executing job, language: {lang}, compiler: {compiler}, opts: {opts}"
    )

    tmpdir = tempfile.mkdtemp()

    try:
        ext_map = {"c": ".c", "cpp": ".cpp", "py": ".py", "python": ".py"}
        ...
        cmd = [EXECUTE_SCRIPT, tmpdir, src_file, lang, compiler, opts]
        ...
        result = {"success": False, "error": "Execution timeout (30s)"}
